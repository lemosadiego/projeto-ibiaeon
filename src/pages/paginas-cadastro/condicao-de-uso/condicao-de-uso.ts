...
/**
 * Generated class for the CondicaoDeUsoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-condicao-de-uso',
  templateUrl: 'condicao-de-uso.html',
})
export class CondicaoDeUsoPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
    public condicaoDao: CondicaoUsoDaoProvider, public session: Session) {
  ...
  selecionaCondicao(condicao) {
    this.navCtrl.push('EditarCondicoesPage', {
