...
/**
 * Generated class for the BuscaEspeciePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-busca-especie',
  templateUrl: 'busca-especie.html',
})
export class BuscaEspeciePage {
  ...
  async ionViewWillEnter() {
    this.empresa = await this.buscaEspecie();
    console.log("Especies encontradas: ", this.empresa);
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
    public especieDao: EspecieDaoProvider, public session: Session,
    private _loadingCtrl: LoadingController) {
      this.Grupo = this.navParams.get('idGrupo');
      console.log("idGrupo", this.Grupo.id);
  ...
  async buscaEspecie() {
    ...
    loading.dismiss();
    return this.especieDao.buscaEspecie(this.clientesRetornados.banco,this.Grupo.id);
  }
  ...
  selecionaEspecie(especie) {
    this.navCtrl.first().data.especieSelecionada = especie;
